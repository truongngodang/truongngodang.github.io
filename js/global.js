(function ($) {
    ...
    // Header
    var header_pri_fix = $('.header.header-primary');
    var header_mob_fix = $('.header.header-mobile, .header.header-push');
    var header_fix = $('.header.header-fixed');
    ...
    $(window).on('load', function () {
        ...
        $(this).on('scroll', function(){
            var fromTop = $(this).scrollTop() + topMenu.outerHeight() + 150;
    ...
    $('.po-btn .load-btn').on('click', function (e) {
        $(this).html("<div class='loader10'></div>").delay(1000).queue(function (next) {
            next();
            $(this).hide();
